...
Route::get('/consumption/yearly-breakdown', [ConsumptionController::class, 'yearlyBreakdownView'])->name('consumption.yearly.breakdown');
Route::get('/consumption/get-yearly-breakdown', [ConsumptionController::class, 'getYearlyBreakdownData'])->name('get.yearly.breakdown');
Route::get('/consumption/export-yearly-breakdown-pdf', [ConsumptionController::class, 'exportYearlyBreakdownPDF'])->name('export.yearly.breakdown.pdf');
...
Route::get('/consumption/export-monthly-breakdown-pdf', [ConsumptionController::class, 'exportMonthlyBreakdownPDF'])->name('export.monthly.breakdown.pdf');
    ...
    Route::post('/vente/update-ligne-quantity', [VenteController::class, 'updateLigneVenteQuantity'])
    ->name('vente.update.ligne.quantity');
    //profile 
